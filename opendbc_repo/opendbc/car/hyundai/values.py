...
class CAR(Platforms):
  ...
  HYUNDAI_IONIQ = HyundaiPlatformConfig(
    ...
    flags=HyundaiFlags.HYBRID | HyundaiFlags.MIN_STEER_32_MPH | HyundaiFlags.MANDO_RADAR | HyundaiFlags.UNSUPPORTED_LONGITUDINAL,
  )
  ...
  HYUNDAI_IONIQ_PHEV_2019 = HyundaiPlatformConfig(
    ...
    CarSpecs(mass=1490, wheelbase=2.7, steerRatio=13.73, tireStiffnessFactor=0.385),
    flags=HyundaiFlags.HYBRID | HyundaiFlags.MIN_STEER_32_MPH | HyundaiFlags.UNSUPPORTED_LONGITUDINAL,
  )
